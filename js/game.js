...
*/
      ...
      prevGenCells = function() {
        ...
        var current_gen = cell_array,
            prev_gen = [],      // New array to hold the next gen cells
            length_y = cell_array.length,
            length_x,
            y, x;
        // each row
        for (y = 0; y < length_y; y++) {
          ...
          for (x = 0; x < length_x; x++) {
            ...
            prev_gen[y][x] = new Cell(x, y, new_state);
            //console.log(next_gen[y][x]);
          }
        }
        return prev_gen;
  ...
  return {
    ...
    step: function(){
      ...
      count++;
      //console.log(count);
      document.getElementById("gen_counter").innerHTML = count;
    },

    // Returns the previous generation array of cells
    back: function(){
      var prev_gen = prevGenCells();
      // Set previous gen as current cell array
      cell_array = prev_gen;
